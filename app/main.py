    ...
    try:
        async with AsyncSessionLocal() as db:
            ...
            try:
                ...
                if cfg and ("https://tektutors.com.ng/registration" not in (cfg.system_prompt or "") or "6)" not in (cfg.system_prompt or "") or "COURSE LISTING" not in (cfg.system_prompt or "") or "₦90,000" not in (cfg.system_prompt or "") or "6-8 wks" not in (cfg.system_prompt or "") or "NEVER USE MARKDOWN TABLES" not in (cfg.system_prompt or "")):
